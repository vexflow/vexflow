...
export class MultiMeasureRest extends Element {
  ...
  constructor(numberOfMeasures: number, options: MultimeasureRestRenderOptions) {
    super();
    const fontSize = options.numberGlyphPoint ?? Metrics.lookupMetric('MultiMeasureRest.fontSize'); // same as TimeSignature.
    ...
    this.renderOptions = {
      ...
      serifThickness: 2,
      semibreveRestGlyphScale: Metrics.lookupMetric('fontSize'), // same as NoteHead.
      paddingLeft: 0,
      paddingRight: 0,
      lineThickness: 5,
      symbolSpacing: 0,
