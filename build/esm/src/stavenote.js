...
export class StaveNote extends StemmableNote {
            ...
            if (noteL.isrest && noteU.isrest && noteU.note.duration === noteL.note.duration) {
                ...
                if (noteU.isrest) {
                    ...
                    if (noteU.note.hasStem() && noteL.note.hasStem()) {
                        const noteUHead = Tables.codeNoteHead((_a = __classPrivateFieldGet(noteU.note, _StaveNote_sortedKeyProps, "f")[0].keyProps.code) !== null && _a !== void 0 ? _a : 'N', noteU.note.duration);
                        const noteLHead = Tables.codeNoteHead((_b = __classPrivateFieldGet(noteL.note, _StaveNote_sortedKeyProps, "f")[__classPrivateFieldGet(noteL.note, _StaveNote_sortedKeyProps, "f").length - 1].keyProps.code) !== null && _b !== void 0 ? _b : 'N', noteL.note.duration);
                        if (!Tables.UNISON ||
                            noteUHead !== noteLHead ||
    ...
    constructor(noteStruct) {
        ...
        this.modifiers = [];
        this.renderOptions = Object.assign(Object.assign({}, this.renderOptions), { glyphFontScale: noteStruct.glyphFontScale || Tables.NOTATION_FONT_SCALE, strokePx: noteStruct.strokePx || StaveNote.LEDGER_LINE_OFFSET });
