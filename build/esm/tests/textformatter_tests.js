...
function basic(assert) {
    ...
    assert.equal(registeredFamilies.length, 5, `There are five registered font families: 'Roboto Slab' & 'Petaluma Script' and default 'Serif', 'Serif-Bold' and 'Sans'`);
    const petalumaFormatterInfo = TextFormatter.getInfo('Petaluma Script');
    assert.equal((_a = petalumaFormatterInfo === null || petalumaFormatterInfo === void 0 ? void 0 : petalumaFormatterInfo.glyphs) === null || _a === void 0 ? void 0 : _a.C.advanceWidth, 623, 'Petaluma Script advanceWidth of C character is 623.');
