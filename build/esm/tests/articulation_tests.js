...
function verticalPlacement2(options, contextBuilder) {
    ...
    const notes = [
        staveNote({ keys: ['f/4'], duration: 'q' })
            .addModifier(new Articulation('\ue4c1'), 0)
            .addModifier(new Articulation('\ue1e7').setPosition(ModifierPosition.BELOW), 0)
            .addModifier(new Articulation('\ue4a5'), 0),
        staveNote({ keys: ['g/4'], duration: 'q', stemDirection: Stem.DOWN })
            .addModifier(new Articulation('\ue4c5'), 0)
            .addModifier(new Articulation('\ue1e7').setPosition(ModifierPosition.BELOW), 0)
        ...
        staveNote({ keys: ['g/4'], duration: 'q', stemDirection: Stem.DOWN })
            ...
            .addModifier(new Articulation('\ue4c9'), 0),
        staveNote({ keys: ['c/5'], duration: 'q' })
            .addModifier(new Articulation('\ue1e7').setPosition(ModifierPosition.BELOW).setBetweenLines(), 0)
            .addModifier(new Articulation('\ue4a5').setBetweenLines(), 0)
            .addModifier(new Articulation('\ue4c1'), 0),
        staveNote({ keys: ['a/5'], duration: 'q', stemDirection: Stem.DOWN })
            .addModifier(new Articulation('\ue4c0'), 0)
            .addModifier(new Articulation('\ue1e7').setPosition(ModifierPosition.ABOVE), 0)
            .addModifier(new Articulation('\ue4a4'), 0),
        staveNote({ keys: ['f/5'], duration: 'q' })
            .addModifier(new Articulation('\ue4c4'), 0)
            .addModifier(new Articulation('\ue1e7').setPosition(ModifierPosition.ABOVE), 0)
        ...
        staveNote({ keys: ['f/5'], duration: 'q' })
            ...
            .addModifier(new Articulation('\ue4c8'), 0),
        staveNote({ keys: ['b/4'], duration: 'q', stemDirection: Stem.DOWN })
            .addModifier(new Articulation('\ue1e7').setPosition(ModifierPosition.ABOVE).setBetweenLines(), 0)
            .addModifier(new Articulation('\ue4a4').setBetweenLines(), 0)
            .addModifier(new Articulation('\ue4c0'), 0),
    ];
    Formatter.FormatAndDraw(ctx, stave, notes);
